...
public abstract class GradleConnector {
    ...
    private static final ToolingImplementationLoader loader = new CachingToolingImplementationLoader(new DefaultToolingImplementationLoader());
    ...
    public static GradleConnector newConnector() {
        ServiceRegistry services = new ConnectorServiceRegistry(loader);
